...
public:
	...
	triangle(Point3f vert0, Point3f vert1, Point3f vert2, Vec3f vn, Vec3f vn2, Vec3f vn3, /*Vec2f uv ,*/ shared_ptr<material> m) : v0(vert0), v1(vert1), v2(vert2), normalX(vn), normalY(vn2), normalZ(vn3), /*UV(uv),*/ mat_ptr(m) {};
...
bool triangle::hit(const Ray& r, double t_min, double t_max, hit_record& rec) const
{
	...
	rec.normal = normalY * u + normalZ * v + normalX * (1.0f -u -v); //normal;
	//rec.u = UV.x;
	//rec.v = UV.y;
